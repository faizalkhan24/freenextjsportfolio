  ...
  <section className="bg-sixty text-white py-16">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div className="bg-thirty p-6 rounded-lg transition-transform transform hover:scale-105  hover:text-ten duration-300 ease-in-out">
      ...
      <Link href="/aboutus" passHref>
        <span className="mt-8 inline-block bg-ten text-white py-2 px-4 rounded-md font-semibold hover:bg-ten cursor-pointer transition-colors duration-300 ease-in-out">
          Read More
        </span>
      </Link>
    </div>
