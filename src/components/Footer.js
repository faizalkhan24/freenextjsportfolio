...
const Footer = () => {
  return (
    <footer className="bg-navbarandfooter  border-t border-gray-600 text-white py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center mb-4">
              <FaMailBulk className="h-5 w-5 mr-2 text-ten" />
              <a href="mailto:info@cybersecexpert.com" className="text-ten hover:underline">info@cybersecexpert.com</a>
            </div>
            <div className="flex items-center mb-4">
              <FaPhone className="h-5 w-5 mr-2 text-ten" />
              <p className="text-sm">Phone: (123) 456-7890</p>
            </div>
            <div className="flex items-center">
              <FaMapMarkerAlt className="h-5 w-5 mr-2 text-ten" />
